...
def check_hand_inside_bounding_box(hand, pts):
    ...
    Note: Since the 3D back-projection is approximate (due to depth estimation and
    calibration noise), you should add a small tolerance/margin (e.g., 5cm) when
    checking boundaries to account for this noise.
    """
